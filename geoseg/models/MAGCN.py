...
class PAM_Module(nn.Module):
    def __init__(self, in_places, scale=8, eps=1e-6):
        ...
        self.query_conv = Conv2d(in_channels=in_places, out_channels=in_places, kernel_size=1)
        self.key_conv = Conv2d(in_channels=in_places, out_channels=in_places, kernel_size=1)
...
class GCN(BaseModel):
    def __init__(self, num_classes, in_channels=3, pretrained=True, use_resnet_gcn=False, backbone='resnet50',
                 use_deconv=False, num_filters=11, freeze_bn=False, **_):
        ...
        self.pa = PAM_Module(num_classes)
        ...
        self.decon1 = nn.ConvTranspose2d(num_classes, num_classes, kernel_size=3, padding=1, output_padding=1, stride=2,
                                         bias=False)
        self.decon2 = nn.ConvTranspose2d(num_classes, num_classes, kernel_size=3, padding=1, output_padding=1, stride=2,
                                         bias=False)
        self.decon3 = nn.ConvTranspose2d(num_classes, num_classes, kernel_size=3, padding=1, output_padding=1, stride=2,
                                         bias=False)
        self.decon4 = nn.ConvTranspose2d(num_classes, num_classes, kernel_size=3, padding=1, output_padding=1, stride=2,
                                         bias=False)
        self.decon5 = nn.ConvTranspose2d(num_classes, num_classes, kernel_size=3, padding=1, output_padding=1, stride=2,
                                         bias=False)
    ...
    def forward(self, x):
        ...
        x1 = self.pa(self.br1(self.gcn1(x1)))   # 改成Sequential
        x2 = self.pa(self.br2(self.gcn2(x2)))
        x3 = self.pa(self.br3(self.gcn3(x3)))
        x4 = self.pa(self.br4(self.gcn4(x4)))
