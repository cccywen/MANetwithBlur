...
class MACCNet(nn.Module):
    def __init__(self, num_channels=3, num_classes=5, backbone_name='resnet50', pretrained=True):
        ...
        self.attention4 = RCCAModule(filters[3], filters[3])
        # self.attention3 = RCCAModule(filters[2], 1024)
        self.attention3 = CAM_Module()
        self.attention2 = RCCAModule(filters[1], filters[3])
        self.attention1 = CAM_Module()
...
def maccnet_base(pretrained=True, num_classes=4, weight_path='/home/caoyiwen/pretrained weights/resnet50-timm.pth'):
    model = MACCNet(num_classes=num_classes)
