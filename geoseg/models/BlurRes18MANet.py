...
class MANet(nn.Module):
    def __init__(self, num_classes=5):  # 改backbone
        ...
        self.encoder1 = resnet.layer1  # 64,64 
        self.encoder2 = resnet.layer2  # 256, 128
        self.encoder3 = resnet.layer3  # 512,256 
...
##################### pretrained=True
def manet_base(pretrained=False, num_classes=4, weight_path='/home/caoyiwen/pretrained weights/resnet18-timm.pth'):
