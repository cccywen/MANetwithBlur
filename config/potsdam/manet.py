...
# from geoseg.models.BlurMANet import manet_base
...
weights_name = "manet-ori-e100"
weights_path = "model_weights/potsdam/{}".format(weights_name)
test_weights_name = "manet-ori-e100-v2"
...
#  define the network
net = manet_base(num_classes=num_classes)
...
val_dataset = PotsdamDataset(data_root='/home/caoyiwen/data/potsdam/val', img_dir='images_1024', mask_dir='masks_1024', img_size=(1024, 1024),
                             transform=val_aug)
test_dataset = PotsdamDataset(data_root='/home/caoyiwen/data/potsdam/test', img_dir='images_1024', mask_dir='masks_1024', img_size=(1024, 1024),
                              transform=val_aug)
