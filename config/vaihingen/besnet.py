...
from geoseg.models.MABES2 import BESNet
...
gpus = [0]
strategy = None
# pretrained_ckpt_path = '/home/caoyiwen/slns/GeoUnetformer/model_weights/vaihingen/bes-e100/bes-e100.ckpt'
