...
def parse_args():
    ...
    parser.add_argument("--img-dir", default="/home/caoyiwen/data/potsdam/test_images")
    parser.add_argument("--mask-dir", default="/home/caoyiwen/data/potsdam/test_masks")
    parser.add_argument("--output-img-dir", default="/home/caoyiwen/data/potsdam/test/images_1024")
    parser.add_argument("--output-mask-dir", default="/home/caoyiwen/data/potsdam/test/masks_1024_rgb")
    parser.add_argument("--eroded", action='store_true')
    parser.add_argument("--gt", default=True)  # output RGB mask
